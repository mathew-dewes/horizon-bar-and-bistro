...
export default function ProductCard({ name, description, image_url, price, quantity}:
    { name: string, description: string, image_url: string | null, price: number, id:string, quantity: number }
) {
    return (
        <div className="w-60">
